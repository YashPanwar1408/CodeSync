    ...
    <div className="container mx-auto py-10">
      ...
      <div className="space-y-8">
        {INTERVIEW_CATEGORY.map((category) => {
          const interviewsInCategory = groupedInterviews[category.id] ?? [];
          if (interviewsInCategory.length === 0) return null;
          ...
          return (
            <section key={category.id}>
              ...
              <div className="flex items-center gap-2 mb-4">
                ...
                <Badge variant={category.variant}>{interviewsInCategory.length}</Badge>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {interviewsInCategory.map((interview: Interview) => {
